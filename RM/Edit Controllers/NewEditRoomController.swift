...
//    var displayBldName = [String]()
//    var displayBldName_Bld = [String: Building]()
//    
...
//                    self.displayBldName = (Array(Set(buildingDisplayName! as [String])) as [String]).sorted()    // alpha. sort
//                    self.displayBldName_toId = dictOfDisplayName_toId! as Dictionary<String, String>
//                }
//            }
//        }
//        
...
//            let _buildingId = displayBldName_toId[bld]
//        {
